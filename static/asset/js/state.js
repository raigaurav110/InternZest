...
const body = document.querySelector("body"),
    ...
    discoverSection = document.querySelector(".discover"),
    ...
    logoText = document.querySelector(".logo a"),
...
window.onscroll = function() {
    ...
    if (pageTitle.text === "LocalBook") {
        ...
        if (window.pageYOffset < headerSection.offsetHeight * 0.5) {
            ...
            window.pageYOffset < discoverSection.offsetTop * 0.72
        ) {
            dots.forEach(dot => dot.classList.add("black"));
        } else if (
            window.pageYOffset > discoverSection.offsetTop * 0.75 &&
